          ...
          <div className="rental-modal-shell">
            <div className="rental-modal-head">
              <div>
                ...
                <p className="rental-modal-subtitle">Thiết kế mobile-first để quét camera liên tục khi cần.</p>
              </div>
              ...
              <div className="rental-form-right">
                <div className="rental-search-row">
                  <div className="rental-search-wrap">
                    ...
                    <input
                      type="text"
                      placeholder="Nhập hoặc scan mã barcode"
            ...
            <div className="rental-modal-foot">
              <div>
                {error ? (
                  ...
                  <p className="rental-tip">Mẹo: Trên mobile, mở Camera để quét liên tục nhiều thiết bị.</p>
                )}
              </div>
