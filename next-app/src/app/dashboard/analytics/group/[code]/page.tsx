...
export default async function GroupDetailPage({ params }: { params: Promise<{ code: string }> }) {
    ...
    return (
        <div className="space-y-10 h-full flex flex-col min-h-0 overflow-hidden animate-in fade-in duration-700">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <div className="flex items-center gap-3">
                            <h1 className="text-3xl font-black text-slate-900 tracking-tight">Nhóm: {label}</h1>
                        ...
                        <p className="text-sm font-bold text-slate-400 mt-1 uppercase tracking-widest leading-relaxed">Phân tích chi tiết mô hình & thiết bị y tế</p>
                    </div>
                </div>
            ...
            {/* Collapsible Groups by Level - Scrollable Area */}
                        ...
                        <div className="hidden md:block overflow-x-auto">
                            ...
                            {group.items.length === 0 && (
                                <div className="py-16 text-center">
                                    <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">Không có thiết bị trong nhóm này</p>
                                </div>
                            )}
                        </div>
                    </CollapsibleGroup>
