    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-xl lg:text-2xl font-bold text-slate-900">Mức độ: {label} ({code})</h1>
                    <p className="text-sm text-slate-500">Phân tích chi tiết thiết bị theo mức độ quan trọng</p>
                </div>
            </div>
            ...
            {/* Collapsible Groups by Group Code */}
            <div className="space-y-4">
                {groups.map((group, idx) => (
                    <CollapsibleGroup
                        ...
                        count={group.count}
                        defaultOpen={idx === 0}
                        colorClass={GROUP_COLORS[group.key] || 'bg-slate-500'}
                    >
